...
void test_list_cyclic_del_first() {
    ...
    *value1 = 84;
    int* value2 = malloc(sizeof(int));
    *value2 = 42;
    List* list = create_list_cyclic(value1, create_list_cyclic(value2, NULL));
    list->next->next = list;
...
//     int* value3 = malloc(sizeof(int));
//     *value3 = 126;
//     List* list = create_list_cyclic(value1, create_list_cyclic(value2, create_list(value3, NULL)));
...
void test_map_list_cyclic() {
    ...
    *value2 = 42;
    int* value3 = malloc(sizeof(int));
    *value3 = 126;
    List* list = create_list_cyclic(value1, create_list_cyclic(value2, create_list_cyclic(value3, NULL)));
    // list->next->next->next = list;
    List* mapped = map_list_cyclic(list, increment_int, free);
    // printf("%p %p %p %p\n", value1, value2, value3, (int*)get_i_element(mapped, 0));
    assert(*(int*)get_i_element(mapped, 0) == 85);
    assert(*(int*)get_i_element(mapped, 1) == 43);
    assert(*(int*)get_i_element(mapped, 2) == 127);
...
void test_copy_list() {
    ...
    *value2 = 42;
    ...
    assert(*(int*)head(copy) == 84);
    assert(*(int*)get_i_element(copy, 1) == 42);
...
void test_copy_cyclic_list() {
    ...
    *value2 = 42;
    ...
    assert(*(int*)head(copy) == 42);
    assert(*(int*)get_i_element(copy, 1) == 84);
